    ...
    async execute (client, message, args, discord){
        try {
            ...
            let embed = new discord.EmbedBuilder()
                ...
                .setDescription(" "+member.user.username + " 𝐅𝐮𝐞 𝐌𝐨𝐫𝐝𝐢𝐝@ 𝐏𝐨𝐫 "+ message.author.username + " ")
                .setImage("https://www.ichimonogatari.com/IMG/Menhera%20Bots/Interaction%20Commands/Bite/Bite"+NumMagic+".gif")
